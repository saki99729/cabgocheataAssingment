    ...
    <%
      ...
      for(Booking booking :bookings)
      {
       ...
       if (booking.getStatus().equals("pending"))
       {
        ...
        out.print("<td>");
        out.print("<form action=\"deletebooking\" method=\"post\">");
        out.print("<input type=\"hidden\" name=\"id\"  id=\"id\" value="+booking.getId()+">");
        out.print("<input type=\"hidden\" name=\"action\" value=\"dview\">");
        out.print("<button type=\"submit\" style='font-size:18px' class=\"btn btn-link\"><i class='fas fa-prescription-bottle'></i></button>");
            out.print ("</td>");
